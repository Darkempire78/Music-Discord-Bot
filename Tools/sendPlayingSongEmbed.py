...
def sendPlayingSongEmbed(self, ctx, music):
    ...
    embed.add_field(name="Loop :", value=str(self.bot.music[ctx.guild.id]["loop"]).replace("True", "<:True:798596718349385799>").replace("False", "<:False:798596718563950653>"), inline=True)
    embed.add_field(name="Loop queue :", value=str(self.bot.music[ctx.guild.id]["loopQueue"]).replace("True", "<:True:798596718349385799>").replace("False", "<:False:798596718563950653>"), inline=True)
